...
-- 既存のポリシーを削除してから作成
DROP POLICY IF EXISTS "Enable all for authenticated users" ON maintenance_schedules;
CREATE POLICY "Enable all for authenticated users" ON maintenance_schedules
