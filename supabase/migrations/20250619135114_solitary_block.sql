/*
  # PayPay Integration Tables and Functions

  1. New Tables
    - `paypay_user_links` - Stores links between users and their PayPay accounts
    - `paypay_payments` - Stores payment information for PayPay transactions
...
-- Also create the new style of indexes for compatibility
