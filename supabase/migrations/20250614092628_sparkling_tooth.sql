/*
  # Add system_alert notification type and development functions

  1. Changes
    - Add 'system_alert' to notifications type check constraint
    - Create function to get latest 2FA code for development
    - Create function to log 2FA codes to notifications for development
*/
