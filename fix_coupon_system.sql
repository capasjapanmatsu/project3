...
CREATE INDEX IF NOT EXISTS idx_user_coupons_facility_id ON user_coupons(facility_id);
...
-- 6. クーポン取得用のRPC関数（修正版：facility_idも追加）
