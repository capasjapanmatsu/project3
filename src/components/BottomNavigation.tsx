...
export function BottomNavigation() {
  ...
  const navUI = (
    ...
    >
      <div className="flex justify-around items-center h-16 bg-white border-t border-gray-200 pointer-events-auto" style={{ paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 2px)' }}>
        {navItems.map((item) => {
