...
export default function DogInfoFoods() {
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      <h1 className="text-2xl font-bold mb-4 text-center">犬が食べてはいけない食べ物</h1>
      ...
      <p className="mb-4">犬にとって危険な食べ物は意外と多く、誤食すると命に関わることもあります。代表的なものとその理由をまとめました。</p>
      ...
      <p>人間には無害でも、犬には危険な食材が多くあります。食卓やゴミ箱の管理、誤食時の早期受診が大切です。</p>
    </div>
  );
} 